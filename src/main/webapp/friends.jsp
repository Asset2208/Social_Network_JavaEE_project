            ...
            <div class="card mb-5">
                <div class="card-body">
                    <form class="form-inline mb-0" method="get" action="/friends">
                        <input type="text" class="form-control mr-sm-2 w-75" name="full_name" placeholder="Search Friends">

                        <button type="submit" class="btn btn-outline-primary ml-auto"><i class="fas fa-search"></i> Search</button>
                    </form>
                </div>
            </div>
                    ...
                    if (search_users != null){
                        for (User user : search_users){
                            if (user.getId() != currentUser.getId()){
                                ...
                                String urlToUser = (is_friend ? "/friend?id="+user.getId() : "/user?id="+user.getId());
            %>
            <div class="card mb-2">
                <div class="card-body d-flex">
                    <a href="<%=urlToUser%>"><img src="<%=user.getPicture_url()%>" style="border-radius: 100%; max-height: 150px; max-width: 150px;"></a>
                    <div class="ml-5">
                        <a href="<%=urlToUser%>"><h5 class="card-title"><%=user.getFullName()%></h5></a>
                        <%
                        ...
                        <div class="row" style="max-height: 40px;">
                            ...
                            <a href="#" class="btn btn-outline-primary ml-3 mr-2" style="max-height: 40px;"><i class="fas fa-plus-square"></i> Add To Friends </a>
